...
export const sendConnectionRequest = async (req, res) => {
    try {
        ...
        res.status(201).json({ message: "Connecetion request sent successfully"});
    }
    catch(error) {
...
export const rejectConncetionRequest = async (req, res) => {
    try {
        const { requestId } = req.params;
        const userId = req.user._id;
...
export const getConnectionStatus = async (req, res) => {
    try {
        ...
        // if no connnection or pending req found
